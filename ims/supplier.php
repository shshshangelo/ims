                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-4 col-xs-6" align="right">
                            <button type="button" name="addSupplier" id="addSupplier" data-bs-toggle="modal" data-bs-target="#supplierModal" class="btn btn-primary bg-gradient btn-sm rounded-0"><i class="far fa-plus-square"></i> Add Supplier</button>
                        </div>
                    </div>					   
            ...
            <div class="modal-dialog modal-dialog-centered rounded-0">
                <div class="modal-content rounded-0">
                    ...
                    <div class="modal-body">
                        <div class="container-fluid">
                            <form method="post" id="supplierForm">
                                ...
                                <input type="hidden" name="btn_action" id="btn_action" value="addSupplier" />
                                <div class="mb-3">
                    ...
                    <div class="modal-footer">
                        <button type="submit" name="action" id="action" class="btn btn-sm rounded-0 btn-primary" form="supplierForm">Save</button>
